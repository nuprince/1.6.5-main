defmodule SpadesGame.GameUIServer do
  ...
  def leave(game_name, user_id) do
    # Get current game_ui state
    game_ui = GenServer.call(via_tuple(game_name), :state)

    # Call GameUI.leave to update seats
    updated_game_ui = GameUI.leave(game_ui, user_id)


    # Persist updated state
    GenServer.call(via_tuple(game_name), {:update, updated_game_ui})
  end
  ...
  def handle_call({:update, new_game_ui}, _from, state) do
    {:reply, new_game_ui, new_game_ui}
  end
